...
/* package lotto-draw-0.1.0.0 */
#ifndef VERSION_lotto_draw
#define VERSION_lotto_draw "0.1.0.0"
#endif /* VERSION_lotto_draw */
#ifndef MIN_VERSION_lotto_draw
#define MIN_VERSION_lotto_draw(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_lotto_draw */
...
#define CURRENT_COMPONENT_ID "lotto-draw-0.1.0.0-inplace-lotto-draw"
